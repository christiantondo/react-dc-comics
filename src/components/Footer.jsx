			...
			<div className="footer-social-section">
				...
				<div className="container-boxed align-center space-between">
					...
					<div className="flex-item align-center">
						...
						<a href="https://www.facebook.com/dc/?brand_redir=248819758864166" target="blank"><img src="/footer-facebook.png" className="social-icons" alt="" /></a>
						<a href="https://maps.app.goo.gl/Bz7eRmazYGsZM1qA7" target="blank"><img src="/footer-periscope.png" className="social-icons" alt="" /></a>
